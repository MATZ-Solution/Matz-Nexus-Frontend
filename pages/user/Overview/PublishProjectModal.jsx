...
import { X, ChevronDown, Sparkles, FileText, Layers, Globe2, Target, Check } from 'lucide-react';
        ...
        <div className="px-8 py-4 flex items-center justify-between gap-3 border-t border-slate-100 bg-slate-50/60">
          ...
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={onClose}
              className="text-xs font-semibold text-slate-600 hover:text-slate-800 px-4 py-2.5 rounded-xl hover:bg-slate-100 transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button
              ...
              className="text-xs font-semibold text-white px-5 py-2.5 rounded-xl hover:opacity-90 shadow-sm shadow-emerald-200 cursor-pointer transition-opacity"
            >
              Publish project
            </button>
          </div>
